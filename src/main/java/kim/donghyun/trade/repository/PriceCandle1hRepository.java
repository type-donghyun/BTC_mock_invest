...
@Repository
public interface PriceCandle1hRepository extends JpaRepository<PriceCandle1h, Long> {
    
    // 선택적으로 조회 기능도 추가 가능
    List<PriceCandle1h> findByCandleTimeBetween(LocalDateTime from, LocalDateTime to);
