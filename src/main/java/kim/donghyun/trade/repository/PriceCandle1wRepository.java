...
@Repository
public interface PriceCandle1wRepository extends JpaRepository<PriceCandle1w, Long> {
    
    // 선택적으로 조회 기능도 추가 가능
    List<PriceCandle1w> findByCandleTimeBetween(LocalDateTime from, LocalDateTime to);
